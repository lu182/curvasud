<?php namespace App\Http\Controllers;
	...
	class AdminCiudadesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "id_ciudad";
			$this->limit = "20";
			$this->orderby = "id_ciudad,desc";
	    ...
	    */
        ...
        public function getEdit($id) {
            ...
            $data['row'] = DB::table('ciudades')->where('id_ciudad',$id)->first();

            //Please use cbView method instead view method from laravel
            $this->cbView('administrador.edicion.ciudades',$data);
          }
