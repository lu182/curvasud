<?php namespace App\Http\Controllers;
	...
	class AdminOrdenesReparacionController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Estado de Orden","name"=>"id_estado_orden","join"=>"estados_ordenes,estadoOrden"];
			...
			$this->col[] = ["label"=>"Apellido de Mecánico","name"=>"id_mecanico","join"=>"mecanicos,apellido"];
			$this->col[] = ["label"=>"Patente del Vehiculo","name"=>"id_vehiculo","join"=>"vehiculos,patente"];
			$this->col[] = ["label"=>"Cliente","name"=>"id_cliente","join"=>"users,apellido"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Estado Orden','name'=>'id_estado_orden','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Fecha Ingreso Vehiculo','name'=>'fecha_ingreso_vehiculo','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Fecha Egreso Vehiculo','name'=>'fecha_egreso_vehiculo','type'=>'date','validation'=>'required|date','width'=>'col-sm-10','datatable'=>'estados_ordenes,estadoOrden'];
			//$this->form[] = ['label'=>'Mecanico','name'=>'id_mecanico','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Vehiculo','name'=>'id_vehiculo','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Cliente','name'=>'id_cliente','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'mecanicos,apellido'];
			# OLD END FORM
