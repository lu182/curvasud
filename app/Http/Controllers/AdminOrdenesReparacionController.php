<?php namespace App\Http\Controllers;
	...
	class AdminOrdenesReparacionController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Fecha Ingreso Vehiculo","name"=>"fecha_ingreso_vehiculo","callback"=>function($row){
                $fecha_nac = $row->fecha_ingreso_vehiculo;
            $fecha_nac = strtotime($fecha_nac);
            $fecha_nac = date('d-m-Y', $fecha_nac);
            return $fecha_nac;
            }];
			$this->col[] = ["label"=>"Fecha Egreso Vehiculo","name"=>"fecha_egreso_vehiculo","callback"=>function($row){
                $fecha_nac = $row->fecha_egreso_vehiculo;
            $fecha_nac = strtotime($fecha_nac);
            $fecha_nac = date('d-m-Y', $fecha_nac);
            return $fecha_nac;
            }];
